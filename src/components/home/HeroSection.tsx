      ...
      <div className="relative container mx-auto px-4 py-16 md:py-20 opacity-95 -mt-12">
        <div className="max-w-3xl">
          ...
          delay: 0.1
            ...
            <Shield className="text-primary w-[18px] h-[18px]" />
          ...
          duration: 0.6,
          delay: 0.2
        }} className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight bg-transparent">
            <span className="text-hero-green text-4xl text-primary">Excellence in Medical Care</span>
            <br />
            <span className="text-gold text-4xl" style={{
          ...
          duration: 0.6,
          delay: 0.3
        }} className="text-base md:text-lg mb-3 leading-relaxed drop-shadow-md max-w-2xl font-sans text-primary font-semibold bg-transparent">
          ...
          delay: 0.4
            ...
            <Link to="/products" className="btn-primary inline-flex items-center justify-center gap-2 text-base">
              Explore Our Solutions
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/contact" className="btn-outline inline-flex items-center justify-center gap-2 text-base">
              Request a Quote
            </Link>
          </motion.div>
